...
export const metadata: Metadata = {
  ...
  openGraph: { title: "openStems | IA local para separación de audio", description: "Separación y gestión de stems con Demucs, ejecutada completamente en local.", url: "https://cesco.dev/proyectos/openstems" },
};

export const translations = {
  ca: {
      ...
      items: [
        {
          ...
          role: "Professor de la UdG · Fundador de GGG, Girona",
    ...
    // CTA
    cta: {
      title: "Preparat per Crear Alguna Cosa Increïble?",
      subtitle: "Sempre estic emocionat per col·laborar en nous projectes i ajudar a donar vida a idees innovadores. Treballem junts.",
    ...
    theme: {
      ...
      saved: "El tema es guarda automàticament",
  ...
  es: {
    ...
    testimonials: {
      ...
      items: [
        {
          author: "Gustavo Patow",
          role: "Profesor de la UdG · Fundador de GGG, Girona",
    ...
    cta: {
      ...
      subtitle: "Siempre estoy emocionado por colaborar en nuevos proyectos y ayudar a dar vida a ideas innovadoras. Trabajemos juntos.",
      btnEmail: "Enviar Email",
      btnCall: "WhatsApp",
    },
    // Footer
    ...
    theme: {
      title: "Selecciona un Tema",
      saved: "El tema se guarda automáticamente",
      select: "Seleccionar tema",
    },
    // Language Selector
    language: {
  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        {
          author: "Gustavo Patow",
          role: "Professor at UdG · Founder of GGG, Girona",
    ...
    cta: {
      ...
      subtitle: "I'm always excited to collaborate on new projects and help bring innovative ideas to life. Let's work together.",
      btnEmail: "Send Email",
      btnCall: "WhatsApp",
    },
    // Footer
    ...
    theme: {
      ...
      saved: "Theme is saved automatically",
      select: "Select theme",
    },
    // Language Selector
    language: {
  ...
  fr: {
    ...
    testimonials: {
      ...
      items: [
        {
          author: "Gustavo Patow",
          role: "Professeur à l'UdG · Fondateur de GGG, Gérone",
    ...
    cta: {
      ...
      subtitle: "Je suis toujours enthousiaste à l'idée de collaborer sur de nouveaux projets et d'aider à donner vie à des idées innovantes. Travaillons ensemble.",
    ...
    theme: {
      ...
      saved: "Le thème est enregistré automatiquement",

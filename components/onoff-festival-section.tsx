  ...
  return <section className="py-24 px-4 overflow-hidden"><div className="max-w-7xl mx-auto">
    <div className="rounded-[2rem] border border-pink-400/25 bg-[linear-gradient(135deg,rgba(244,114,182,.08),transparent_50%)] overflow-hidden">
      <div className="grid lg:grid-cols-2">
        ...
        <div className="relative min-h-[360px] lg:min-h-full bg-black flex items-center">
          <iframe className="w-full aspect-video" src="https://www.youtube-nocookie.com/embed/Et51ZgcMuR8?rel=0&modestbranding=1" title={t.video} loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen />

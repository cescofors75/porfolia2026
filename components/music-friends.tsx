...
export function MusicFriends({ language }: { language: Language }) {
  ...
  return <article className="pt-32 pb-24 px-4 overflow-hidden"><div className="max-w-7xl mx-auto">
    ...
    <div className="grid lg:grid-cols-2 gap-6 mb-8">
      ...
      <section className="rounded-3xl border border-emerald-500/20 bg-card/30 overflow-hidden"><div className="relative aspect-[16/9]"><Image src="/music-friends/limabeatz.webp" alt="Limabeatz, proyecto de Javi Lara" fill sizes="(max-width:1024px) 100vw, 50vw" className="object-cover" /></div><div className="p-6 md:p-8 flex items-start justify-between gap-4"><div><p className="text-xs uppercase tracking-widest text-emerald-400 mb-2">Spotify</p><h2 className="font-display text-3xl font-bold">Limabeatz</h2><p className="text-sm font-medium text-emerald-400/80 mt-1">Javi Lara</p><p className="text-sm text-muted-foreground mt-2">{t.lima}</p></div><Headphones className="text-emerald-400" /></div><div className="px-4 md:px-6"><EmbedFacade title="Limabeatz on Spotify" className="rounded-xl" height={300} label={t.tap} accentClass="border-emerald-500/30 text-emerald-400" src="https://open.spotify.com/embed/artist/4YfPlncfssK9STwd3lroil?utm_source=generator" /></div><a href="https://open.spotify.com/intl-es/artist/4YfPlncfssK9STwd3lroil" target="_blank" rel="noopener noreferrer" className="m-6 md:m-8 mt-5 inline-flex items-center gap-2 text-sm font-semibold text-emerald-400">{t.listen} Spotify <ArrowUpRight size={15} /></a></section>
    </div>
    ...
    <section className="mb-8 overflow-hidden rounded-3xl border border-sky-500/20 bg-card/30">
      <div className="grid md:grid-cols-[240px_1fr]">
        <div className="relative h-52 overflow-hidden border-b border-white/10 md:h-auto md:min-h-72 md:border-b-0 md:border-r">
          <Image src="/music-friends/manel-alsina.webp" alt="Manel Alsina" fill sizes="(max-width:768px) 100vw, 240px" className="object-cover" />
        </div>
        <div className="p-6 md:p-8">
          <p className="text-xs uppercase tracking-widest text-sky-400">SoundCloud</p>
          <h2 className="mt-2 font-display text-3xl font-bold">Manel Alsina</h2>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{t.manel}</p>
          <EmbedFacade title="Manel Alsina on SoundCloud" className="mt-5 overflow-hidden rounded-xl" height={120} label={t.tap} accentClass="border-sky-500/30 text-sky-400" src="https://w.soundcloud.com/player/?url=https%3A%2F%2Fapi.soundcloud.com%2Fusers%2F6441252&color=%2338bdf8&auto_play=false&show_artwork=false&show_user=true" />
          <a href="https://soundcloud.com/manelalsina" target="_blank" rel="noopener noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-sky-400">{t.listen} SoundCloud <ArrowUpRight size={15} /></a>
        </div>
      </div>
    </section>
    ...
    <section className="rounded-3xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/[.09] via-card/40 to-red-500/[.05] overflow-hidden mb-8"><div className="grid lg:grid-cols-[.86fr_1.14fr] items-stretch"><div className="relative min-h-96 bg-[#0794bb]"><Image src="/music-friends/nico-cabanas.webp" alt="Estado de Bienestar, proyecto de Nico Cabañas" fill sizes="(max-width:1024px) 100vw, 45vw" className="object-cover" /><span className="absolute bottom-3 left-3 rounded-full bg-black/70 px-3 py-1 text-[10px] uppercase tracking-widest text-white/70">Estado de Bienestar · Oráculo Records</span></div><div className="p-7 md:p-12 flex flex-col justify-center"><p className="text-xs uppercase tracking-[.2em] text-cyan-400 mb-3">Oráculo Records · Ombra Festival</p><h2 className="font-display text-4xl md:text-6xl font-bold">Nico Cabañas</h2><p className="mt-6 text-base md:text-lg text-muted-foreground leading-relaxed">{nicoCopy[language]}</p><EmbedFacade title="Estado de Bienestar — Capítulo IV" className="mt-7 rounded-xl border-0" height={340} label={t.tap} accentClass="border-cyan-500/30 text-cyan-400" src="https://bandcamp.com/EmbeddedPlayer/album=679811586/size=large/bgcol=111111/linkcol=22d3ee/artwork=small/transparent=true/" /><div className="mt-8 flex flex-wrap gap-5"><a href="https://www.keyimagazine.com/2025/05/24/estado-de-bienestar-oraculo-records/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-400">Estado de Bienestar <ArrowUpRight size={15} /></a><a href="https://oraculorecords.bandcamp.com/album/cap-tulo-iv-la-fiesta-seria-y-nuevas-formas-de-tecnaco" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-400">{t.listen} Bandcamp <ArrowUpRight size={15} /></a><a href="https://ombrafestival.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-400">Ombra Festival <ArrowUpRight size={15} /></a></div></div></div></section>
    ...
    <div className="grid lg:grid-cols-2 gap-6 mb-8">
      ...
      <section className="rounded-3xl border border-violet-500/20 bg-gradient-to-b from-violet-500/[.07] to-card/30 overflow-hidden flex flex-col"><div className="relative aspect-[16/9]"><Image src="/music-friends/replicante-norman.webp" alt="Replicante Norman" fill sizes="(max-width:1024px) 100vw, 50vw" className="object-cover" /></div><div className="p-7 md:p-9"><p className="text-xs uppercase tracking-widest text-violet-400 mb-2">Electro · Ambient · Science fiction</p><h2 className="font-display text-4xl font-bold">Replicante Norman</h2><p className="text-muted-foreground mt-5 leading-relaxed">{replicanteCopy[language]}</p><div className="mt-5 flex flex-wrap gap-2"><span className="rounded-full border border-violet-500/25 px-3 py-1 text-xs text-violet-300">Electronic Hearts Studio</span><span className="rounded-full border border-violet-500/25 px-3 py-1 text-xs text-violet-300">Mars Frequency Records</span><span className="rounded-full border border-violet-500/25 px-3 py-1 text-xs text-violet-300">2004—</span></div></div><div className="space-y-4 px-4 md:px-6"><EmbedFacade title="Replicante Norman on SoundCloud" height={260} label={t.tap} accentClass="border-violet-500/30 text-violet-400" src="https://w.soundcloud.com/player/?url=https%3A%2F%2Fsoundcloud.com%2Freplicantenorman&color=%238b5cf6&auto_play=false&show_artwork=true&show_user=true" /><EmbedFacade title="The Transformer by Replicante Norman" className="rounded-xl border-0" height={340} label={t.tap} accentClass="border-violet-500/30 text-violet-400" src="https://bandcamp.com/EmbeddedPlayer/album=4175190070/size=large/bgcol=111111/linkcol=a78bfa/artwork=small/transparent=true/" /><EmbedFacade title="Replicante Norman on YouTube" className="aspect-video rounded-xl" height={315} label={t.tap} accentClass="border-violet-500/30 text-violet-400" src="https://www.youtube-nocookie.com/embed/tCXJa752rec" /></div><div className="m-7 md:m-9 mt-5 flex flex-wrap gap-5"><a href="https://soundcloud.com/replicantenorman" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-violet-400">{t.listen} SoundCloud <ArrowUpRight size={15} /></a><a href="https://www.discogs.com/search/?q=replicante+norman&type=all" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-violet-400">Discogs <ArrowUpRight size={15} /></a><a href="https://replicantenorman.bandcamp.com/album/the-transformer" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-violet-400">The Transformer · Bandcamp <ArrowUpRight size={15} /></a><a href="https://youtu.be/tCXJa752rec" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-violet-400">Replicante Norman · YouTube <ArrowUpRight size={15} /></a></div></section>
    </div>
      ...
      <div className="grid lg:grid-cols-3">
        ...
        <article className="relative flex flex-col overflow-hidden border-b border-white/10 bg-cyan-500/[.035] lg:border-b-0 lg:border-r">
          <div className="relative flex h-52 flex-col justify-between overflow-hidden p-7">
            ...
            <p className="relative text-xs uppercase tracking-[.22em] text-cyan-400">Zoom Club · Lloret de Mar</p>
            <div className="relative"><p className="font-mono text-xs tracking-[.3em] text-white/35">1998—2012</p><h3 className="mt-2 font-display text-5xl font-bold tracking-tight">Alex Klar</h3></div>
          </div>
